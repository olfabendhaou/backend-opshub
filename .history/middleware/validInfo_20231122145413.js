...
exports.registerValidator = (req, res, next) => {
    const req.body={firstname, lastname, jobtitle, company, city, postalcode,country, state, language, timezone, telephone, emailadress, password}
    check(req.firstname, "Insert your firstname!").not().isEmpty();
