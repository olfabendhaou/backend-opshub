...
const createUserAction=require ("/Users/olfabendhaou/Desktop/Internship-Backend/db/userDb.js")
...
const createUserAction = async (req, res) => {
  ...
  try{
    const action_user = await createUserAction({login, name, surname, email, action, action_time});
