...
const updateUserDb = async ({
  ...
  const { rows: user } = await pool.query(
    `UPDATE Users2 set firstname =$1, lastname=$2, jobtitle=$3, company=$4, city=$5, postalcode=$6 ,country=$7, state=$7, language=$8, timezone=$9, telephone=$10, emailadress=$, password
