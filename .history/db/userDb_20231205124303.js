...
const createUserAction = async ({login, name, surname, email, action, action_time}) => {
  const { rows: sys_ui_audit } = await pool.query(
    `INSERT INTO sys_ui_audit  (firstname, lastname, jobtitle, company, city, postalcode,country, state, language, timezone, telephone, emailadress, password ) 
