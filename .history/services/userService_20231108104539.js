const {
  ...
  class UserService {
    ...
    updateUser = async (user) => {
        const { firstname, lastname, jobtitle, company, city, postalcode,country, state, language, timezone, telephone, emailadress, password } = user;
        const errors = {};
        try {
          ...
          const emailChanged =
            emailadress && getUser.emailadress.toLowerCase() !== emailadress.toLowerCase();
          const usernameChanged =
          firstname && getUser.firstname.toLowerCase() !== username.toLowerCase();
